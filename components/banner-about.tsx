...
const BannerAbout = () => {
  return (
    <div className="lg:flex lg:h-auto lg:w-3/5 mx-auto bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-300 to-blue-500 rounded-xl mb-12">
      {/* ---- Left Side ------ */}
      <div className="flex flex-col items-center m-4 text-center  text-white font-extrabold drop-shadow-xl mx-auto ">
        ...
        <div className="flex flex-col lg:flex-row gap-x-4 w-full px-8 lg:justify-center lg:pt-4">
          <Link href="/wolne-wizyty/user_2n1u8b2jrjY5iSaD2FPsGK7cdd3">
            <Button
              variant="signIn"
              size="lg"
              className="w-full lg:w-auto rounded-full my-4"
            >
              Wolne terminy
            </Button>
          </Link>
