...
const Services = () => {
  return (
    <div className="flex flex-col justify-center items-center">
      <h2 className="text-blue-500 text-2xl font-extrabold">
        Czym się wyróżniam?
      </h2>
      <h3 className="text-blue-600 font-semibold text-lg mt-4">
        Wybitną opieką fizjoterapeutyczna!
      </h3>
      <p className="text-center text-blue-600 text-sm mt-8">
      ...
      <div className="flex flex-col gap-y-4 xl:flex-row justify-center gap-x-40 mb-6 mt-16 mx-20">
        <div className="flex flex-col items-center border rounded-xl p-4 shadow-lg hover:bg-blue-50 hover:shadow-2xl">
          <div className="bg-blue-400 flex-none rounded-full p-8 ">
            <Image
          ...
          <h3 className="mt-5 text-center text-blue-500 font-bold text-md drop-shadow-xl">
            Innowacyjne podejście
          </h3>
          <p className="text-center mt-2 text-blue-500 drop-shadow-2xl text-sm">
